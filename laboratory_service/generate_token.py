#!/usr/bin/env python
"""
Script to generate JWT tokens for testing the laboratory service.
...
Roles can be one of: DOCTOR, PATIENT, ADMIN, LAB_TECHNICIAN
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument('--role', choices=['DOCTOR', 'PATIENT', 'ADMIN', 'LAB_TECHNICIAN'], default='DOCTOR',
